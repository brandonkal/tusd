...
func ParseFlags() {
	...
	flag.StringVar(&Flags.HttpHooksEndpoint, "hooks-http", "", "An HTTP endpoint to which hook events will be sent to (TUS_API_KEY environment variable can be set to pass an API-Key header)")
